...
export default function Footer() {
  ...
  return (
    ...
    >
      <nav className="container px-3 py-2 mx-auto text-white sm:px-14 md:px-36 ml:px-72 lg:px-80 xl:px-96 text-13 sm:text-15 ml:text-16 xl:text-18 font-agrandir">
